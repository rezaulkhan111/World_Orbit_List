...
public class MainActivity extends AppCompatActivity implements CountryAdapter.ICallback {
    ...
    public List<Satellite> USA_Satellite_List() {
        ...
        USA_Sat_Obj.add(new Satellite(43482,"IRIDIUM 162","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43481,"IRIDIUM 110","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43480,"IRIDIUM 147","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43479,"IRIDIUM 152","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43478,"IRIDIUM 161","","",R.mipmap.ic_united_states_of_america_foreground));
        ...
        USA_Sat_Obj.add(new Satellite(43258,"IRIDIUM 143","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43257,"IRIDIUM 150","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43256,"IRIDIUM 142","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43255,"IRIDIUM 148","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43254,"IRIDIUM 146","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43253,"IRIDIUM 145","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43252,"IRIDIUM 140","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43251,"IRIDIUM 157","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43250,"IRIDIUM 149","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(43249,"IRIDIUM 144","","",R.mipmap.ic_united_states_of_america_foreground));
        ...
        USA_Sat_Obj.add(new Satellite(42964,"IRIDIUM 125","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42963,"IRIDIUM 139","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42962,"IRIDIUM 136","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42961,"IRIDIUM 132","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42960,"IRIDIUM 107","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42959,"IRIDIUM 119","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42958,"IRIDIUM 129","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42957,"IRIDIUM 122","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42956,"IRIDIUM 100","","",R.mipmap.ic_united_states_of_america_foreground));
        USA_Sat_Obj.add(new Satellite(42955,"IRIDIUM 133","","",R.mipmap.ic_united_states_of_america_foreground));
