...
public class MainActivity extends AppCompatActivity implements CountryAdapter.ICallback {
    ...
    public List<Satellite> USA_Satellite_List() {
        ...
        USA_Sat_Obj.add(new Satellite(42058,"USA 274","","Mar-1-2017",R.mipmap.ic_united_states_of_america_foreground));
        ...
        USA_Sat_Obj.add(new Satellite(41893,"ECHOSTAR 19","Comm: Traffic Monitoring","Dec-18-2016",R.mipmap.ic_united_states_of_america_foreground));
        ...
        USA_Sat_Obj.add(new Satellite(27378,"ECHOSTAR 7","Communication","Feb-21-2002",R.mipmap.ic_united_states_of_america_foreground));
